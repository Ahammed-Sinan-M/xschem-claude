...
nogui_tests=" test_descend_refusal_channel_0251 test_descend_symbol test_nogui test_sweep_diff test_make_symbol_dialog test_ase_core test_ase_final test_ase_final_gf180 test_placement_preview_doors test_paste_modify_flag_0244 test_shape_draw_gate test_placement_wire_gate test_verilog_view_model test_vcd_read test_ase_cosim test_raw_ascii_point_bounds test_vcd_time_base test_raw_read_dispatch test_raw_read_failure_0306 test_raw_case_mode test_ngspice_data_view test_node_token_split test_wave_cursor_crossdb test_backannotate_digital test_cosim_golden_e2e test_sim_casemode_registry test_sim_probe test_sim_run_profile test_sim_plain_run test_ase_sod_case test_ase_preflight test_ase_result_case test_zero_point_raw_0836 test_zero_point_pos_at_0852 test_results_freshness test_annot_stale_0684 test_annot_blank_cause_0909 test_annot_hier_0911 test_spice_get_node_0861 test_recent_conf_compat_0924 test_ase_simreg_0931 test_ase_simcaps_0948 test_ase_optier_0963 test_unused_attr_0970 test_auto_specialize_1201 test_hash_extra_node_warn_0165 test_lib_new_path_guards_0799 test_descend_doors_1228 test_annot_op_behind_tran_1242 test_op_dump_altshow "
